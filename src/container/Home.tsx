...
import {Container, IconButton, Link, Tooltip, Typography, Paper} from "@mui/material";
        ...
        <Container maxWidth="sm">
          <Typography variant="body2" align="center" style={{fontSize: '1rem'}}>
            ...
            <Tooltip title="Github">
              <IconButton component={Link} href="https://github.com/VARattleff" target="_blank" color="inherit">
                <GitHubIcon/>
              </IconButton>
            </Tooltip>
          </Typography>
